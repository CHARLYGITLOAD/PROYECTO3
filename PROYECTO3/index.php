...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/carrusel-imagenes/Flores.jpg" class="d-block w-100" alt="..." width="600px" height="600px">  
      <div class="carousel-caption d-none d-md-block">
        <h5 class="fs-4 text-primary p-2 mb-2 bg-transparent text-white bg-dark">Aprovecha el 10% de decuento en tu primer compra</h5>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/carrusel-imagenes/Flores2.jpg" class="d-block w-100" alt="..." width="600px" height="600px">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="fs-4 text-danger p-2 mb-2 bg-transparent text-white bg-dark">Aprovecha el envio gratis en compras a partir de $599.00</h5>
      </div>
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
     ...
     <main class="container m-5">
      <div class="row">
        <div class="col-8">
          <select class="form-select mb-3" aria-label="Defaul select example" 
     id="categoria">
